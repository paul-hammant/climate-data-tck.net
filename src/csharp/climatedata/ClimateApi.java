...
import climatedata.domain.web.AnnualData;
import climatedata.domain.web.AnnualGcmDatum;
import com.thoughtworks.xstream.XStream;  // there is an XSteeam.net, but is it best practice?
